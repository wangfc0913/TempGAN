...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        It also gathers additional options defined in <modify_commandline_options> functions in both IRImages class and model class.
        """
        ...
        parser.add_argument('--dataset_mode', type=str, default='ir', help='aligned,single')
        parser.add_argument('--model', type=str, default='temp_gan', help='chooses which model to use. bicycle,, ...')
        ...
        parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per IRImages. If the IRImages directory contains more than max_dataset_size, only a subset is loaded.')
    ...
    def gather_options(self):
        ...
        Add additional model-specific and IRImages-specific options.
        These options are difined in the <modify_commandline_options> function
        in model and IRImages classes.
        """
        ...
        #
        # # modify IRImages-related parser options
